...
latex_documents = [
    (master_doc, 'meerkat_auth.tex', 'meerkat\\_auth Documentation',
...
man_pages = [
    (master_doc, 'meerkat_auth', 'meerkat_auth Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'meerkat_auth', 'meerkat_auth Documentation',
     author, 'meerkat_auth', 'One line description of project.',
     'Miscellaneous'),
]
